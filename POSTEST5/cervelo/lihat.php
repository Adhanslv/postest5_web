...
<body>
    ...
    <p class="info">Data Sepeda Cervelo</p>
    <table>
        <tr>
            <th>ID</th>
            <th>ID Data</th>
        ...
        <tr>
            ...
            <td colspan='2'>
                <a class="ubah"  href="ubah.php?id_cervelo=<?php echo $data ['id_cervelo']?>" onclick="return confirm('Ingin Mengubah Data?');" role="button">
                ...
                <a class="hapus" href="hapus.php?id_cervelo=<?php echo $data ['id_cervelo']?>" onclick="return confirm('Ingin Mengapus Data?');" role="button">
        ...
        <?php
            ...
            $nRows = $dbh->query('select count(*) from tb_cervelo')->fetchColumn();
